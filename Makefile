...
SOURCES=VSHost.c VStudio.c VSJam.c VSEffect.c VSTMediaPlayer.c VSTVideoPlayer.c AudioDev.c AudioMic.c AudioSpk.c AudioMixer.c AudioPipeNB.c VideoQueue.c YUV420RGBgl.c
OBJECTS=$(SOURCES:.c=.o)
EXECUTABLE=VSHost
